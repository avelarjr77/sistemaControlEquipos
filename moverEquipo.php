...
<head>
    ...
    <title>Mover Equipo | Sistema control UCAD</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                     ...
                     <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Mover Equipo</h1>
                     <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below.
                         For more information about DataTables, please visit the <a target="_blank"
                             href="https://datatables.net">official DataTables documentation</a>.</p>

                    <!-- Formulario | Agregar Equipos -->
                    <div class="card shadow mb-4 sd">
                        <div class="card-header py-2">
                            <h6 class="m-0 font-weight-bold text-primary">Mover Equipo</h6>
                        </div><br>

                        <div class="card-body">
                            <div class="table-responsive container">
                                <form action="models/mover.php" method="POST" name="frm" id="frm" autocomplete="off" >
                                    <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-outline-success btn-block mt-4" id="btn_operacion">Mover</button>
                                            </div> 
                                        </div>                                  
