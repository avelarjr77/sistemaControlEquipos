...
<head>
    ...
    <title>Editar | Sistema control UCAD</title>
...
<body id="page-top">
    ...
    <?php 
        ...
        $con=conectar();
        $datosDB = base64_decode($_GET['id']);
        $datosDB = unserialize($datosDB);
    
        $sql="SELECT * FROM equipo WHERE idEquipo='" . $datosDB['idEquipo'] . "'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                     ...
                     <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Editar equipo</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <h6 class="m-0 font-weight-bold text-primary">Actualizar Equipo</h6>
                        </div><br>

                        <div class="card-body">
                            <div class="table-responsive container">
                                <form action="models/update.php" method="POST" name="frm" id="frm" autocomplete="off" >
                                    <div class="row">
                                    <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Id Equipo</label>
                                                <input readonly name="idEquipo" type="number" value="<?php echo $datosDB['idEquipo'] ?>" class="form-control" id="idEquipo" placeholder="Id equipo">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                    $q2="SELECT * From tipoequipo order by idTipoEquipo";
                                                    $query2=mysqli_query($con, $q2);
                                                    while($f=mysqli_fetch_array($query2)){
                                                        $idTipoEquipo=$f['idTipoEquipo'];
                                                        $detalleTipoEquipo=$f['detalleTipoEquipo'];
                                                    ?>
                                                  <option value="<?php echo $idTipoEquipo=$f['idTipoEquipo'] ?>"><?php echo $detalleTipoEquipo=$f['detalleTipoEquipo'] ?></option>
                                                  <?php 
                                                     } 
                                                  ?>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="Inventario" value="<?php echo $datosDB['Inventario']; ?>" type="text" class="form-control" id="Inventario" placeholder="Inventario">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="Marca" value="<?php echo $datosDB['Marca'];?>" type="text" class="form-control" id="Marca" placeholder="Marca">
                                            </div>
                                        </div>
                                        <div class="col-md-4">                                    
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Modelo</label>
                                                <input name="Modelo" value="<?php echo $datosDB['Modelo'];?>"type="text" class="form-control" id="Modelo" placeholder="Marca">                                              
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleFormControlInput1">Serie</label>
                                                <input name="serieEquipo" value="<?php echo $datosDB['serieEquipo']; ?>" type="number" class="form-control" id="serieEquipo" placeholder="Serie">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                        $q2="SELECT * From departamento order by idDepartamento";
                                                        $query2=mysqli_query($con, $q2);
                                                        while($f=mysqli_fetch_array($query2)){
                                                            $idDepartamento=$f['idDepartamento'];
                                                            $departamentos=$f['departamentos'];
                                                    ?>
                                                  <option value="<?php echo $idDepartamento=$f['idDepartamento'] ?>"><?php echo $departamentos=$f['departamentos'] ?></option>
                                                  <?php 
                                                     } 
                                                  ?>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                        $q2="SELECT * From estado order by idEstado";
                                                        $query2=mysqli_query($con, $q2);
                                                        while($f=mysqli_fetch_array($query2)){
                                                            $idEstado=$f['idEstado'];
                                                            $detalleEstado=$f['detalleEstado'];
                                                    ?>
                                                  <option value="<?php echo $idEstado=$f['idEstado'] ?>"><?php echo $detalleEstado=$f['detalleEstado'] ?></option>
                                                  <?php 
                                                     } 
                                                  ?>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-outline-success btn-block mt-4" id="btn_operacion">Actualizar</button>
                                            </div>                                           
                                        </div>
                                    </div>    
