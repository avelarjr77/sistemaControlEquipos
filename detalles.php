...
<head>
    ...
    <title>Equipos | Sistema control UCAD</title>
...
<body id="page-top">
    ...
    <?php 
        ...
        $sql="SELECT 
        dispositivos.detalleDispositivo Dispositivo,
        marca.marca Marca, 
        modelo.detalleModelo Modelo,
        serieDispositivo
        from cpudispositivo
        INNER JOIN dispositivos
        ON cpudispositivo.idDispositivos = dispositivos.IdDispositivos
        INNER JOIN marca
        ON cpudispositivo.IdMarca = marca.IdMarca
        INNER JOIN modelo
        ON cpudispositivo.IdModelo = modelo.IdModelo
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card-header py-2">
                ...
                <nav class="navbar navbar-light bg-light">
                    <a class="navbar-brand">Detalle del equipo</a>
            ...
            <div class="card-body">
                <h3>Equipo: <?php echo "#" .$idEquipo?></h3>
                <div class="table">
                        ...
                        <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $filas['serieDispositivo']        ?></td>
