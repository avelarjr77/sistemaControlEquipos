...
<head>
    ...
    <title>Equipos Prestados | Sistema control UCAD</title>
...
<body id="page-top">
    ...
    <?php 
        ...
        FROM prestamoequipo
        INNER JOIN usuario
        On prestamoequipo.idUsuario = usuario.idUsuario 
        order by idPrestamoEquipo asc  ";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                     ...
                     <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Equipos Prestados</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <h6 class="m-0 font-weight-bold text-primary">Prestar Equipos</h6>
                        </div><br>

                        <div class="card-body">
                            <div class="table-responsive container">
                                <form action="models/prestar.php" method="POST" name="frm" id="frm" autocomplete="off" >
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="fechaPrestamo" type="date" class="form-control" id="fechaPrestamo" placeholder="fechaPrestamo">
                                                </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">      
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-outline-success btn-block mt-4" id="btn_operacion">Prestar</button>
                                            </div>                                           
                                        </div>
                                    </div>        
                     ...
                     <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Equipos Prestados</h6>
                        </div><br>
                         
                         <div class="card-body">
                            <div class="table-responsive" id="dataTable">
                                <table class="table  id="dataTable" width="70%" cellspacing="0">
                                    <thead>
                                             <tr>
                                         ...
                                         <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td><?php echo $filas['fechaPrestamo']   ?></td>
