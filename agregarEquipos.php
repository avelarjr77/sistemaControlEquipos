...
<head>
    ...
    <title>Centro de computo I | Sistema control UCAD</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                     ...
                     <!-- Page Heading -->
                     <h1 class="h3 mb-2 text-gray-800">Agregar equipos</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <h6 class="m-0 font-weight-bold text-primary">Agregar Equipos</h6>
                        </div><br>

                        <div class="card-body">
                            <div class="table-responsive container">
                                <form action="models/form_validator.php" method="POST" name="frm" id="frm" autocomplete="off" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                  <option ><?php echo $detalleTipoEquipo=$f['detalleTipoEquipo'] ?></option>
                                                  <?php 
                                                     } 
                                                  ?>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="Inventario" type="text" class="form-control" id="Inventario" placeholder="Inventario">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">                                    
                                            <div class="form-group">
                                                ...
                                                <input name="serieEquipo" type="text" class="form-control" id="serieEquipo" placeholder="Serie">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">      
                                            <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-outline-success btn-block mt-4" id="btn_agregar">Agregar</button>
                                            </div>                                           
                                        </div>
                                    </div>    
                    ...
                    <br><br>
                     <!-- Formulario | Agregar Tipo de Equipos -->
                     <div class="card shadow mb-4">
                        <div class="card-header py-2">
                            <h6 class="m-0 font-weight-bold text-primary">Agregar tipo de equipo</h6>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive container">
                                <form action="models/tipoEquipo.php" method="POST" name="frm" id="frm" autocomplete="off" >
                                    <div class="row">
                                        
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Tipo de Equipo</label>
                                                <input name="detalleTipoEquipo" type="text" class="form-control" id="detalleTipoEquipo" placeholder="Tipo Equipo">
                                            </div>
                                        </div>
                                        <div class="col-md-6">      
                                            <div class="form-group">
